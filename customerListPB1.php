                        ...
                        <tbody class="clientsInfoForm">
                            <tr class="clientsInfo">
                                ...
                                <td class="edit">
                                    ...
                                    <button type="button" class="del_btn"><img src="./image/delete.png"></button>
    ...
    objXMLHttpRequest.onreadystatechange = function() {
        if (objXMLHttpRequest.readyState === 4 && objXMLHttpRequest.status === 200) {
            ...
            if (response.data.length > 0) {
                ...
                clientsInfo.querySelector('.total_portion').textContent = response.data[0].total_portion;
            ...
            for (var i = 1; i < response.data.length; i++) {
                ...
                newRow.querySelector('.total_investment').textContent = response.data[i]
                    .total_investment;
                newRow.querySelector('.cash_investment').textContent = response.data[i].cash_investment;
