...
function updateTotalInvestment() {
  ...
  pb_part = ((pb_percent / 100) * total_investment).toFixed(0);
  ...
  pf_part = ((pf_percent / 100) * total_investment).toFixed(0);
...
function updateClientPortion() {
  ...
  client_portion = (total_investment * (pf_percent / 100)).toFixed(0);
  ...
  discount_amount = ((policy_discount_rate / 100) * total_portion).toFixed(0);
...
function updateTotalBonus() {
  ...
  total_portion = parseFloat(total_portionInput.value.replace(/,/g, "")) || 0;
  bonus_amount = ((total_portion * welcome_bonus) / 100).toFixed(0) || 0;
  ...
  total_bonus = (bonus_amount + discount_amount + coupon).toFixed(0);
...
function updateInvestmentReturn() {
  ...
  od_amount = (pb_part1 * multiplier - pb_part1).toFixed(0);
  ...
  mgt_fee = ((mgt_fee_rate / 100) * total_investment_pb).toFixed(0);
  //console.log(mgt_fee);
  ...
  for (let i = 0; i < select_int_yield.length; i++) {
    ...
    annual_int_return = (total_investment_pb * (int_yield / 100)).toFixed(0);
...
function updateFinancingInt() {
  ...
  // console.log("-------");
  // console.log(pmt);
  // console.log(mortgage_amount_pb);
  // console.log(policy_financing_pb);
  // console.log(od_amount);
  // console.log(bank_portion);
  // console.log(financing_rate);
  // console.log("--------");
...
function updateNetReturn() {
  ...
  for (let i = 0; i < net_returnInput.length; i++) {
    ...
    net_returnInput[i].value = parseFloat(net_return).toLocaleString();
    //console.log(parseFloat(net_return).toLocaleString());
    accum_npInput[i].value = parseFloat(net_return.toFixed(0)).toLocaleString();
  }
}
